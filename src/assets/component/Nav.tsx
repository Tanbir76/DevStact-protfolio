...
function Nav() {
    return (
        ...
        <div className=" container mx-auto navbar flex justify-between py-4 ">
            <div className=" hidden navbar-start md:hidden ">
            ...
            <div>
                <ul className=" flex gap-2 md:gap-8 text-[16px]  font-[88px] text-[#475569] ">
            ...
            <div className="flex gap-2 ">
                <button className="btn border-none bg-white">Sing In</button>
                <button className="btn rounded-3xl text-white bg-[#D91B7E] ">Sing UP</button>
